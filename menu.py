...
class Main_Menu(object):
    ...
    pyglet.font.add_file('Fonts\cubic.ttf')
    ...
    def init_window(self, SCREEN_H, SCREEN_W):
        ...
        mainWindow = pyglet.window.Window(SCREEN_H, SCREEN_W, caption = "Minecraft Pi | Community Edition | Menu")
